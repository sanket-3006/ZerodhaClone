    ...
    return ( 
        <div className="container">
           <div className="row mt-5 mb-5">
            <h3 className="fw-normal text-muted mb-5" style={{paddingLeft:"80px"}}>To create a ticket, select a relevant topic</h3>
            <div className="col-4" style={{paddingLeft:"80px"}}>
                <h3 className="fw-normal text-muted pb-3"> <i class="fa-solid fa-circle-plus fa-xs"></i> Account Opening
                </h3>
            ...
            <div className="col-4">
            <h3 className="fw-normal text-muted pb-3"> <i class="fa-regular fa-user fa-xs"></i> Your Zerodha Account
                </h3>
            ...
            <h3 className="fw-normal text-muted pb-3"> <i class="fa-solid fa-chart-simple fa-xs"></i> Trading and Markets
                </h3>
           ...
           <div className="row">
            <div className="col-4" style={{paddingLeft:"80px"}}>
                <h3 className="fw-normal text-muted pb-3"> <i class="fa-regular fa-hard-drive fa-sm"></i> Funds
                </h3>
            ...
            <div className="col-4">
            <h3 className="fw-normal text-muted pb-3"> <i class="fa-solid fa-circle-notch fa-sm"></i> Console
                </h3>
            ...
            <div className="col-4" style={{paddingRight:"80px"}}>
            <h3 className="fw-normal text-muted pb-3"> <i class="fa-brands fa-bitcoin fa-sm"></i> Coin
                </h3>
