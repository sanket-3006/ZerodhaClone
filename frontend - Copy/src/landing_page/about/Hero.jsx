    ...
    return (
        <div className="container">
            <div className="row mt-5 mb-5 ">
                <h1 className="fs-2 mb-5 text-center">We pioneered the discount broking model in India. <br />
                    Now, we are breaking ground with our technology.</h1>
            </div>
            <div className="row p-5 mt-5 border-top text-muted fs-6 lh-lg " style={{fontSize:"1.2 rem"}}>
